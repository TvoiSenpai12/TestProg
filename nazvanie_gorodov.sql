...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 14 2022 г., 02:39
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3 COMMENT='Города';

--
-- Дамп данных таблицы `geo_city`
--
...
--
ALTER TABLE `geo_city`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1490;
COMMIT;
